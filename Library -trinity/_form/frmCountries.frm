...
Begin VB.Form frmCountries 
   ...
   Begin VB.Frame fraList 
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "You can view list of Countries."
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
...
Public Function PRINT_RECORD(Index As Integer)
    ...
    If Index = 0 Then
        ...
        Set dtrCountry.DataSource = rsView1
        dtrCountry.Show 1
    End If
End Function
...
Private Sub Form_Load()
    ...
    Lv_MainInfo
    lvList(0).Refresh
    frmMain.TabMainIni 2, "Countries", 11
    'ListOfDisabledBtn
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    frmMain.TabMainIni 1, "Countries", 11
End Sub
...
Private Sub lvList_DblClick(Index As Integer)
    If Index = 0 Then
        If iRec(Index) > 0 Then
            frmCountries_AE.bStat = False
            Set frmCountries_AE.fCur = Me
            frmCountries_AE.Show 1
        End If
    End If
End Sub
...
Public Sub Lv_MainInfo()
    ...
    iLoop(0) = 0
    sFields(0) = "country"
    sNoRec(0) = "No Current Country Records."
    iStartPage(0) = 1
    iNoPage(0) = 75
    ...
    If iRec(Index) > 0 Then
        If Index = 0 Then
            ...
            If MsgBox(sMsgDel, vbQuestion + vbYesNo, "Delete") = vbYes Then
                DELETE_DATA "tbl_country", "country", lvList(Index).SelectedItem.SubItems(1)
